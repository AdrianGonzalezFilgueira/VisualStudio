...
let radiocuadrado = Math.pow(23,2);
let numeroPi = Math.PI

let area = numeroPi * radiocuadrado;
console.log("Valor de PI:", numeroPi);
console.log("Valor de radio:", radiocuadrado);
 ...
 */
 console.log("Valor de area decimales:", area.toFixed(2));
 console.log("Valor de area redondeado:", Math.round(area));