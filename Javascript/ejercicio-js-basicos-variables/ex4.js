...
let numeroGatos = 10;
let proximapareja = "la Muerte";
let pais = "Canadá"
let trabajoperfecto = "Programador FullStack en Altia"

let futuro = "Tú estarás en " + pais + " trabajando de " + trabajoperfecto + " y tu pareja será " + proximapareja + " y tendréis " + numeroGatos + " gatos";
console.log(futuro);